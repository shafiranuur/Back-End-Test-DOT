    ...
    <nav class="navbar navbar-static-top">
      <!-- Sidebar toggle button-->
            <div class="pull-right" style="margin-top: 7px;margin-right: 10px">
                  <a href="<?php echo base_url('index.php/home/logout');?>" class="btn btn-default" action="">Sign out</a>
                </div>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
          ...
          if ($this->session->userdata('level')=='admin') {
            echo '
                ...
                <a>
                  ...
                  <li><a href="'.base_url("index.php/home/admin_view").'"><i class="fa fa-circle-o"></i> Admin</a></li>
                  <li><a href="'.base_url("index.php/home/buku_view").'"><i class="fa fa-circle-o"></i> Data Buku</a></li>
                  <li><a href="'.base_url("index.php/home/kategori_view").'"><i class="fa fa-circle-o"></i>Kategori Buku</a></li>
                </li> 
            ';
          } elseif ($this->session->userdata('level')=='kasir') {
            echo '
              <li class="treeview">
                <a href="'.base_url("index.php/home/transaksi_view").'">
        ...
        <!-- <li class="active">
          <a href="<?php echo base_url();?>assets/blank.html">
